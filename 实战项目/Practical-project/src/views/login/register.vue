<template>
  <div class="register-contain">
    <header class="register-title" @click="toPage('/')">WOTAO 卧涛商户</header>
      ...
      <div class="form-contain">
        ...
        <el-form ref="ruleFormRef" :model="form" :rules="rules" label-width="10rem">
          ...
          <el-form-item label="确认密码：" prop="confirmPwd">
            <el-input size="large" v-model="form.confirmPwd" placeholder="再次输入密码" :show-password="true" />
          </el-form-item>
        </el-form>
        <el-button size="large" type="primary" class="btn-sty" @click="submitForm(ruleFormRef)">注 册</el-button>
        <div class="login-text" @click="toPage('/Login')">立即登录</div>
      </div>
    </div>
  </div>
</template>
