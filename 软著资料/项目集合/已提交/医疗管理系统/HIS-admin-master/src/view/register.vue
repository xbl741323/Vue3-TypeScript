		...
		<div class="registerContainer">
			...
			<div class="mainContainer">
				...
				<div class="tabNav" style="">
					<div class="tab-menu" style="display: inline-block;height: 40px;">
						<div @click="selectTab = 1" class="tabDiv">
							<div class="tabTitle1" :class="{ greenBgcolor: selectTab == 1 }"></div>
							<div class="sjx" :class="{ greenBorderSjx: selectTab == 1 }"></div>
							<span class="titleSpan" :class="{ whiteTitleSpan: selectTab == 1 }">服务协议</span>
						</div>
						<div @click="selectTab = 2" class="tabDiv">
							<div class="tabTitle" :class="{ greenBorderTitle: selectTab == 2 }"></div>
							<div class="sjx" :class="{ greenBorderSjx: selectTab == 2 }"></div>
							<span class="titleSpan" :class="{ whiteTitleSpan: selectTab == 2 }">提交诊所资质</span>
						</div>
						<div @click="selectTab = 3" class="tabDiv">
							<div class="tabTitle" :class="{ greenBorderTitle: selectTab == 3 }"></div>
							<div class="sjx" :class="{ greenBorderSjx: selectTab == 3 }"></div>
							<span class="titleSpan" :class="{ whiteTitleSpan: selectTab == 3 }">完成诊所信息</span>
						</div>
						<div @click="selectTab = 4" class="tabDiv">
							<div class="tabTitle" :class="{ greenBorderTitle: selectTab == 4 }"></div>
							<div class="sjx" :class="{ greenBorderSjx: selectTab == 4 }"></div>
				...
				<div class="tabPancel" style="margin-bottom:30px;" v-show="selectTab == 1">
					<div class="tab-pancel-item">
						...
						<div>
							...
							<p style="line-height:28px;">
								本专家医生、医技设备、住院床位是医院最紧缺的医疗服务资源之一，全院统一预约管理系统可实现人员与资源的合理分配，节约患者等待时间，推动医疗服务资源发挥最大效能，更好地辅助医院经营决策。
					...
					<el-checkbox class="agreeCheckbox" v-model="agreeItem">同意《医疗管理系统服务条款》</el-checkbox><br />
					<button @click="confirmRead()" v-show="!showProgress">确定</button>
					<el-progress :text-inside="true" :stroke-width="18" v-bind:percentage="progressPercent"
							...
							<el-row>
								...
								<el-col :span="12">
									<el-form-item prop="date1">
										<el-date-picker type="date" placeholder="选择日期" v-model="tabPancel2Info.date"
					...
					<div class="tab-pancel-item">
						...
						<el-form label-width="80px">
							...
							<el-form-item label="设置密码：">
								<el-input placeholder="设置您的登录密码，请使用6~16位大小写字母、数字组合" v-model="tabPancel4Info.pwd"
...
.registerApp .tabPancel3 .el-upload-list__item,
.registerApp .is-success {
