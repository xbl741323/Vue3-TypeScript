<template>
  <div class="map-outbox">
    ...
    <div class="carMessage">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;
      <el-button @click="queryCarTrack">查询222222222</el-button><br/>
      <div style="margin: 10px;" v-if="messageDept != ''">
...
<script>
import { getPositionStatusList } from "@/api/carmonitoring";
