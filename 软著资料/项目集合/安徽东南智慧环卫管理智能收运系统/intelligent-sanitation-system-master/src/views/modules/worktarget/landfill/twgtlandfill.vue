<template>
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-worktarget__twgtlandfill">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item>
          <el-button v-if="$hasPermission('worktarget:twgtlandfill:save')" type="primary" @click="addOrUpdateHandle()">{{ $t('add') }}</el-button>
        </el-form-item>
        <el-form-item>
          <el-button v-if="$hasPermission('worktarget:twgtlandfill:delete')" type="danger" @click="deleteHandle()">{{ $t('deleteBatch') }}</el-button>
        </el-form-item>
      </el-form>
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="handleModeName" label="处置方式" header-align="center" align="center"></el-table-column>
        <el-table-column prop="designCapability" label="处理能力" header-align="center" align="center"></el-table-column>
        <el-table-column prop="annualHandleAmount" label="年处置量" header-align="center" align="center"></el-table-column>
        <el-table-column prop="annualCost" label="运行成本" header-align="center" align="center"></el-table-column>
        <el-table-column prop="workerCount" label="人员数量" header-align="center" align="center"></el-table-column>
        <el-table-column prop="powerGenerateAmount" label="年发电量" header-align="center" align="center"></el-table-column>
        <el-table-column prop="residualAmount" label="残渣产量" header-align="center" align="center"></el-table-column>
        <el-table-column prop="address" label="地址" header-align="center" align="center"></el-table-column>
        <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
          <template slot-scope="scope">
            <el-button v-if="$hasPermission('worktarget:twgtlandfill:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">{{ $t('update') }}</el-button>
            <el-button v-if="$hasPermission('worktarget:twgtlandfill:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">{{ $t('delete') }}</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <!-- 地图 -->
        <div class="map" id="container" :style="[{ width: foldStatus ? '40%' : '100%' }]">
        </div>
      <!-- 弹窗, 新增 / 修改 -->
...
import AddOrUpdate from './twgtlandfill-add-or-update'
...
export default {
  ...
  data () {
    return {
      ...
      mixinViewModuleOptions: {
        getDataListURL: '/worktarget/twgtlandfill/listPage',
        getDataListIsPage: true,
        exportURL: '/worktarget/twgtlandfill/export',
        deleteURL: '/worktarget/twgtlandfill',
        deleteIsBatch: true
      },
      dataForm: {
        name: ''
  ...
  methods: {
    ...
    openWindowInfo (polygon) {
      ...
      info.push('<tr><td class="info-content-key">处理能力：</td><td class="info-content-value">' + polygon.designCapability + '</td></tr>')
      info.push('<tr><td class="info-content-key">处置方式：</td><td class="info-content-value">' + polygon.handleModeName + '</td></tr>')
      info.push('<tr><td class="info-content-key">年处置量：</td><td class="info-content-value">' + polygon.annualHandleAmount + '</td></tr>')
      info.push('<tr><td class="info-content-key">地址：</td><td class="info-content-value">' + polygon.address + '</td></tr>')
      info.push('</table></div>')
      var infoWindow = new AMap.InfoWindow({
