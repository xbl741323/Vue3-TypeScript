  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-worktarget__twgtworktargetcleanload">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="worktargetName"  label="环卫设施" header-align="center" align="center">
          <template slot-scope="scope">
              <span @click="showDialog(scope.row)" :class="scope.row.cleanCount > 0 ?'worktargetName-class': ''">{{ scope.row.worktargetName }}</span>
          </template>
        </el-table-column>
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/worktarget/twgtworktargetcleanload/getReportInfo4ReportType',
        getDataListIsPage: true,
        exportURL: '/worktarget/twgtworktargetcleanload/export',
