  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-vehwork__workload">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="overSpeedTimes" label="超速违规次数" header-align="center" align="center"></el-table-column>
        <el-table-column prop="overTimeTimes" label="停车违规次数" header-align="center" align="center"></el-table-column>
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/vehwork/tvehcommonworkload/getWorkloadReportBetweenDate',
