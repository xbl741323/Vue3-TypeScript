...
import { GETMACHINECLEAN_CARTYPELIST } from '@/api/cartype/cartype.js'
...
export default {
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/vehwork/tvehmachinecleanworkload/getWorkloadReportBetweenDate',
  ...
  methods: {
	  getCarTypeList () {
          GETMACHINECLEAN_CARTYPELIST({}).then(({ data: res }) => {
	      if (res.code === 0) {
