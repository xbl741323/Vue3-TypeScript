  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-worker__twkrworkload">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="workerTypeName" label="人员类型" header-align="center" align="center"></el-table-column>
        <el-table-column prop="deptName" label="部门" header-align="center" align="center"></el-table-column>
        <el-table-column v-if="dateInfoShow" prop="startWorkTime" label="到岗时间" header-align="center" align="center"></el-table-column>
        <el-table-column v-if="dateInfoShow" prop="endWorkTime" label="离岗时间" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="yuejieLong" label="越界时长" :formatter="timeFormatter" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="zhiliuLong" label="滞留时长" :formatter="timeFormatter" header-align="center" align="center"></el-table-column>
        <el-table-column v-if="false" prop="homeZhiliuNum" label="住址滞留次数" header-align="center" align="center"></el-table-column>
        <el-table-column v-if="false" prop="homeZhiliuLong" label="住址滞留时间" :formatter="timeFormatter" header-align="center" align="center"></el-table-column>
        <el-table-column prop="xunchaNum" label="巡查次数" header-align="center" align="center"></el-table-column>
        <el-table-column prop="xunchaMileage" label="巡查里程" :formatter="doubleFormmater" header-align="center" align="center"></el-table-column>
        <el-table-column prop="xunchaLong" label="巡查时长" :formatter="timeFormatter" header-align="center" align="center"></el-table-column>
      </el-table>
      <el-pagination
        :current-page="page"
...
export default {
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/wkr-old/workerworkloadadapter/getWorkerWorkloadReportBetweenDate',
        getDataListIsPage: true,
        exportURL: '/wkr-old/workerworkloadadapter/exportWorkerWorkloadReportBetweenDate',
  ...
  methods: {
    ...
    doubleFormmater (row, column, cellValue, index) {
      console.log(cellValue)
